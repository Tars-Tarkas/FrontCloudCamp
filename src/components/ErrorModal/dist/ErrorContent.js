...
var ErrorContent_module_css_1 = require("./ErrorContent.module.css");
var Button_1 = require("../Button/Button");
exports.ErrorContent = function () {
    ...
    return (React.createElement("div", { className: ErrorContent_module_css_1["default"].block },
        React.createElement("div", { className: ErrorContent_module_css_1["default"].header },
            React.createElement("label", { className: ErrorContent_module_css_1["default"].title }, "\u041E\u0448\u0438\u0431\u043A\u0430"),
            React.createElement("button", { className: ErrorContent_module_css_1["default"].btn }, icon_close)),
        React.createElement("div", { className: ErrorContent_module_css_1["default"].icon__block },
            React.createElement("span", { className: ErrorContent_module_css_1["default"].icon }, icon_error)),
        React.createElement(Button_1.Button, { tag: "\u0417\u0430\u043A\u0440\u044B\u0442\u044C", theme: "primary" })));
};
